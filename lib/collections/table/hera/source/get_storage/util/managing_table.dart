...
class ManagingGetStorageTableHera {

  GetStorageTableHera get() {
    final box = GetStorage();

    String? json = box.read('ManagingGetStorageTableHera');
    if (json == null) return GetStorageTableHera();

    return GetStorageTableHera.fromString(json);
  }

  upsert(GetStorageTableHera obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingGetStorageTableHera', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingGetStorageTableHera');
  }
}


class GetStorageTableHera {
  ...
  static GetStorageTableHera fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = GetStorageTableHera();
