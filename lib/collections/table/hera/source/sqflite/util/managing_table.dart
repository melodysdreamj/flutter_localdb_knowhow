...
class ManagingSqfliteTableHera {

  SqfliteTableHera get() {
    final box = GetStorage();

    String? json = box.read('ManagingSqfliteTableHera');
    if (json == null) return SqfliteTableHera();

    return SqfliteTableHera.fromString(json);
  }

  upsert(SqfliteTableHera obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingSqfliteTableHera', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingSqfliteTableHera');
  }
}


class SqfliteTableHera {
  ...
  static SqfliteTableHera fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = SqfliteTableHera();
