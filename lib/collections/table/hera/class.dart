...
class Hera {
  Hera() {
    DocId = HeraConfig.to.generateDocId();
  }
  ...
  static Hera fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = Hera();

    obj.HowManyTimeDo = data['HowManyTimeDo'] ?? 0;
