...
class ManagingSharedPreferencesTableNewModel {

  SharedPreferencesTableNewModel get() {
    final box = GetStorage();

    String? json = box.read('ManagingSharedPreferencesTableNewModel');
    if (json == null) return SharedPreferencesTableNewModel();

    return SharedPreferencesTableNewModel.fromString(json);
  }

  upsert(SharedPreferencesTableNewModel obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingSharedPreferencesTableNewModel', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingSharedPreferencesTableNewModel');
  }
}


class SharedPreferencesTableNewModel {
  ...
  static SharedPreferencesTableNewModel fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = SharedPreferencesTableNewModel();
