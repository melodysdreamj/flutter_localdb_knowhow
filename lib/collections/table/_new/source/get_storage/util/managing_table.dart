...
class ManagingGetStorageTableNewModel {

  GetStorageTableNewModel get() {
    final box = GetStorage();

    String? json = box.read('ManagingGetStorageTableNewModel');
    if (json == null) return GetStorageTableNewModel();

    return GetStorageTableNewModel.fromString(json);
  }

  upsert(GetStorageTableNewModel obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingGetStorageTableNewModel', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingGetStorageTableNewModel');
  }
}


class GetStorageTableNewModel {
  ...
  static GetStorageTableNewModel fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = GetStorageTableNewModel();
