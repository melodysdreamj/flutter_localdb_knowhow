...
class ManagingSembastTableNewModel {

  SembastTableNewModel get() {
    final box = GetStorage();

    String? json = box.read('ManagingSembastTableNewModel');
    if (json == null) return SembastTableNewModel();

    return SembastTableNewModel.fromString(json);
  }

  upsert(SembastTableNewModel obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingSembastTableNewModel', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingSembastTableNewModel');
  }
}


class SembastTableNewModel {
  ...
  static SembastTableNewModel fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = SembastTableNewModel();
