...
class ManagingFireStoreTableNewModel {

  FireStoreTableNewModel? get() {
    final box = GetStorage();

    String? json = box.read('ManagingFireStoreTableNewModel');
    if (json == null) return null;

    return FireStoreTableNewModel.fromString(json);
  }

  upsert(FireStoreTableNewModel obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingFireStoreTableNewModel', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingFireStoreTableNewModel');
  }
}


class FireStoreTableNewModel {
  ...
  static FireStoreTableNewModel fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = FireStoreTableNewModel();
