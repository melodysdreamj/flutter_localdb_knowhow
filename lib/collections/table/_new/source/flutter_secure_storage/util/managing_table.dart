...
class ManagingSecureStorageTableNewModel {

  SecureStorageTableNewModel get() {
    final box = GetStorage();

    String? json = box.read('ManagingSecureStorageTableNewModel');
    if (json == null) return SecureStorageTableNewModel();

    return SecureStorageTableNewModel.fromString(json);
  }

  upsert(SecureStorageTableNewModel obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingSecureStorageTableNewModel', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingSecureStorageTableNewModel');
  }
}


class SecureStorageTableNewModel {
  ...
  static SecureStorageTableNewModel fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = SecureStorageTableNewModel();
