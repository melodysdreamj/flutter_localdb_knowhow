...
class NewModelSqflite {
  ...
  Future<int> update(NewModel object, NewModel oldObject) async {
    ...
    return await NewModelDb.update(
        'NewModel', toMap(object: oldObject),
  ...
  _prepare() async {
    ...
    NewModelDb = await openDatabase(path, version: 1);
    _isDbOpened = true;
  }
  ...
  createIndexing(Database myDatabase) async {
    ...
    if (prefs.getBool("NewModelIndex") != null) {
      return;
    }
    await prefs.setBool("NewModelIndex", true);
