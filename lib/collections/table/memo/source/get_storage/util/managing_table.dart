...
class ManagingGetStorageTableMemo {

  GetStorageTableMemo get() {
    final box = GetStorage();

    String? json = box.read('ManagingGetStorageTableMemo');
    if (json == null) return GetStorageTableMemo();

    return GetStorageTableMemo.fromString(json);
  }

  upsert(GetStorageTableMemo obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingGetStorageTableMemo', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingGetStorageTableMemo');
  }
}


class GetStorageTableMemo {
  ...
  static GetStorageTableMemo fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = GetStorageTableMemo();
