...
class ManagingFireStoreTableMemo {

  FireStoreTableMemo? get() {
    final box = GetStorage();

    String? json = box.read('ManagingFireStoreTableMemo');
    if (json == null) return null;

    return FireStoreTableMemo.fromString(json);
  }

  upsert(FireStoreTableMemo obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingFireStoreTableMemo', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingFireStoreTableMemo');
  }
}


class FireStoreTableMemo {
  ...
  static FireStoreTableMemo fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = FireStoreTableMemo();
