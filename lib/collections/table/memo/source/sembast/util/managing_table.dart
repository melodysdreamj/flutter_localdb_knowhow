...
class ManagingSembastTableMemo {

  SembastTableMemo get() {
    final box = GetStorage();

    String? json = box.read('ManagingSembastTableMemo');
    if (json == null) return SembastTableMemo();

    return SembastTableMemo.fromString(json);
  }

  upsert(SembastTableMemo obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingSembastTableMemo', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingSembastTableMemo');
  }
}


class SembastTableMemo {
  ...
  static SembastTableMemo fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = SembastTableMemo();
