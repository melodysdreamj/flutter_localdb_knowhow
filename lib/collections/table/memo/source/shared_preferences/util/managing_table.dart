...
class ManagingSharedPreferencesTableMemo {

  SharedPreferencesTableMemo get() {
    final box = GetStorage();

    String? json = box.read('ManagingSharedPreferencesTableMemo');
    if (json == null) return SharedPreferencesTableMemo();

    return SharedPreferencesTableMemo.fromString(json);
  }

  upsert(SharedPreferencesTableMemo obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingSharedPreferencesTableMemo', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingSharedPreferencesTableMemo');
  }
}


class SharedPreferencesTableMemo {
  ...
  static SharedPreferencesTableMemo fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = SharedPreferencesTableMemo();
