...
class ManagingSecureStorageTableMemo {

  SecureStorageTableMemo get() {
    final box = GetStorage();

    String? json = box.read('ManagingSecureStorageTableMemo');
    if (json == null) return SecureStorageTableMemo();

    return SecureStorageTableMemo.fromString(json);
  }

  upsert(SecureStorageTableMemo obj) {
    final box = GetStorage();
    String json = obj.toString();
    box.write('ManagingSecureStorageTableMemo', json);
  }

  delete() {
    final box = GetStorage();
    box.remove('ManagingSecureStorageTableMemo');
  }
}


class SecureStorageTableMemo {
  ...
  static SecureStorageTableMemo fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = SecureStorageTableMemo();
