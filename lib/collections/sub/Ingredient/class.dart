...
class Ingredient {
  ...
  // List<String> L019 = [];
  // List<String> L020 = [];
  // List<Ingredient2> J000 = [];
  // List<Ingredient2> J001 = [];
  // List<Ingredient2> J002 = [];
  // List<Ingredient2> J003 = [];
  // List<Ingredient2> J004 = [];
  // List<Ingredient2> J005 = [];
  // List<Ingredient2> J006 = [];
  // List<Ingredient2> J007 = [];
  // List<Ingredient2> J008 = [];
  // List<Ingredient2> J009 = [];
  // List<Ingredient2> J010 = [];
  // List<Ingredient2> J011 = [];
  // List<Ingredient2> J012 = [];
  // List<Ingredient2> J013 = [];
  // List<Ingredient2> J014 = [];
  // List<Ingredient2> J015 = [];
  // List<Ingredient2> J016 = [];
  // List<Ingredient2> J017 = [];
  // List<Ingredient2> J018 = [];
  // List<Ingredient2> J019 = [];
  // List<Ingredient2> J020 = [];
  ...
  static Ingredient fromString(String jsonString) {
    final data = jsonDecode(jsonString);
    var obj = Ingredient();

    obj.Quantity = data['Quantity'] ?? 0;
    ...
    // obj.L019 = data['L019'] ?? [];
    // obj.L020 = data['L020'] ?? [];
    // obj.J000 = (jsonDecode(data['J000'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J001 = (jsonDecode(data['J001'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J002 = (jsonDecode(data['J002'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J003 = (jsonDecode(data['J003'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J004 = (jsonDecode(data['J004'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J005 = (jsonDecode(data['J005'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J006 = (jsonDecode(data['J006'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J007 = (jsonDecode(data['J007'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J008 = (jsonDecode(data['J008'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J009 = (jsonDecode(data['J009'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J010 = (jsonDecode(data['J010'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J011 = (jsonDecode(data['J011'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J012 = (jsonDecode(data['J012'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J013 = (jsonDecode(data['J013'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J014 = (jsonDecode(data['J014'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J015 = (jsonDecode(data['J015'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J016 = (jsonDecode(data['J016'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J017 = (jsonDecode(data['J017'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J018 = (jsonDecode(data['J018'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J019 = (jsonDecode(data['J019'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
    // obj.J020 = (jsonDecode(data['J020'] ?? '[]') as List).map((item) => Ingredient2.fromString(item)).toList();
